  ...
  return (
    <aside className="w-64 bg-white shadow-xl flex-shrink-0 min-h-screen flex flex-col border-r border-gray-100">
      ...
      <nav className="flex-1 px-4 py-6 space-y-2">
        <a href="#" className="flex items-center gap-3 px-4 py-3 bg-indigo-50 text-indigo-700 rounded-xl font-semibold transition">
        ...
        <a href="#" className="flex items-center gap-3 px-4 py-3 text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-xl font-medium transition cursor-pointer">
